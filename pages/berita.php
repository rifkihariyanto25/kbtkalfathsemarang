...
$items_per_page = 6; // Menggunakan 6 items sesuai template 2
    ...
    <section class="py-8 bg-white shadow-md">
        <div class="container mx-auto px-4">
            <div class="flex flex-wrap justify-center gap-4" data-aos="fade-up">
                <a href="?page=1" class="filter-button px-6 py-2 rounded-full border-2 border-gray-300 font-medium text-gray-700 hover:border-brand-orange hover:text-brand-orange <?php echo empty($kategori) ? 'active' : ''; ?>">
                    Semua
                </a>
                <a href="?kategori=pengumuman&page=1" class="filter-button px-6 py-2 rounded-full border-2 border-gray-300 font-medium text-gray-700 hover:border-brand-orange hover:text-brand-orange <?php echo $kategori === 'pengumuman' ? 'active' : ''; ?>">
                    Pengumuman
                </a>
                <a href="?kategori=kegiatan&page=1" class="filter-button px-6 py-2 rounded-full border-2 border-gray-300 font-medium text-gray-700 hover:border-brand-orange hover:text-brand-orange <?php echo $kategori === 'kegiatan' ? 'active' : ''; ?>">
                    Kegiatan
                </a>
                <a href="?kategori=prestasi&page=1" class="filter-button px-6 py-2 rounded-full border-2 border-gray-300 font-medium text-gray-700 hover:border-brand-orange hover:text-brand-orange <?php echo $kategori === 'prestasi' ? 'active' : ''; ?>">
                    Prestasi
                </a>
            </div>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <?php foreach ($berita_items as $index => $item): ?>
                        <div class="bg-white rounded-lg shadow-md overflow-hidden" data-aos="fade-up" data-aos-delay="<?php echo $index * 50; ?>">
                            <div class="relative">
                                <?php
                                // Path gambar dengan pengecekan dari code 1
